			...
			<div class='card'>
			    ...
			    <div class='card-body'>
			    	...
			    	<dl class="row">
					  ...
					  <dd class="col-sm-9">${show_cartellaEsattoriale_attr.stato}</dd>
					</dl>
			    	...
			    	<dl class="row">
					  ...
					  <dd class="col-sm-9">${show_cartellaEsattoriale_attr.contribuente.codiceFiscale}</dd>
					</dl>
			    	<dl class="row">
					  <dt class="col-sm-3 text-right">Data di nascita:</dt>
					  <dd class="col-sm-9"><fmt:formatDate type = "date" value = "${show_cartellaEsattoriale_attr.contribuente.dataDiNascita}" /></dd>
			    	</dl>
			    	<dl class="row">
