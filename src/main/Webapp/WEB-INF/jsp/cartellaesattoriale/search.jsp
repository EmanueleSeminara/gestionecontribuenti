				    ...
				    <div class='card-body'>
							...
							<form method="post" action="list" class="row g-3">
								...
								<div class="col-md-6">
									...
									<input type="text" name="importo" id="importo" class="form-control" placeholder="Inserire l'importo" >
								</div>
								...
								<div class="col-md-6">
									...
									<input class="form-control ${status.error ? 'is-invalid' : ''}" type="text" id="contribuenteSearchInput"
										name="contribuenteInput" value="${search_cartellaesattoriale_attr.contribuente.nome}${empty search_cartellaesattoriale_attr.contribuente.nome?'':' '}${search_cartellaesattoriale_attr.contribuente.cognome}">
									<input type="hidden" name="contribuente.id" id="contribuenteId" value="${search_cartellaesattoriale_attr.contribuente.id}">
								</div>
