			...
			<main class="flex-shrink-0">
			  ...
			  <div class='card'>
				    ...
				    <div class='card-body'>
							...
							<form method="post" action="${pageContext.request.contextPath}/contribuente/list" class="row g-3" >
								...
								<div class="col-md-6">
									...
									<input type="text" class="form-control" name="indirizzo" id="indirizzo" placeholder="Inserire il codice indirizzo"  >
								</div>
