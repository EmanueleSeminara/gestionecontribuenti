				...
				<div class="container">
					...
					<div class='card'>
					    ...
					    <div class='card-body'>
							...
							<form:form modelAttribute="edit_contribuente_attr"  method="post" action="${pageContext.request.contextPath }/contribuente/update" novalidate="novalidate" class="row g-3">
								<form:hidden path="id"/>
								...
								<div class="col-md-6">
									...
									<spring:bind path="codiceFiscale">
										<input type="text" class="form-control ${status.error ? 'is-invalid' : ''}" name="codiceFiscale" id="codiceFiscale" placeholder="Inserire il codiceFiscale" value="${edit_contribuente_attr.codiceFiscale }" required>
									</spring:bind>
								...
								<div class="col-md-6">
									...
									<spring:bind path="indirizzo">
										<input type="text" class="form-control ${status.error ? 'is-invalid' : ''}" name="indirizzo" id="indirizzo" placeholder="Inserire il indirizzo" value="${edit_contribuente_attr.indirizzo }" required>
									</spring:bind>
