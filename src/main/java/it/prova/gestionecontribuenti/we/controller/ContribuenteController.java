...
public class ContribuenteController {
	...
	public String showFilm(@PathVariable(required = true) Long idContribuente, Model model) {
		model.addAttribute("show_contribuente_attr", ContribuenteConCartelleDTO
				.buildContribuenteConCartelleDTOFromModel(contribuenteService.caricaSingoloElemento(idContribuente)));
	...
	public String remove(@RequestParam(required = true) Long idDaRimuovere, RedirectAttributes redirectAttrs) {
		...
		try {
			...
			redirectAttrs.addFlashAttribute("errorMessage", enf.getMessage());
			return "redirect:/contribuente";
		} catch (ContribuenteConCartelleEsattorialiException rcf) {
			redirectAttrs.addFlashAttribute("errorMessage", rcf.getMessage());
			return "redirect:/contribuente";
		} catch (IllegalArgumentException ia) {
			redirectAttrs.addFlashAttribute("errorMessage", ia.getMessage());
			return "redirect:/contribuente";
		}
		redirectAttrs.addFlashAttribute("successMessage", "Operazione eseguita correttamente");
		return "redirect:/contribuente";
